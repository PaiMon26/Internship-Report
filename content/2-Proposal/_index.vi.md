...
- **Cách hoạt động:**
  ...
  - Hệ thống dùng: - **Weighted Scoring** → lọc & xếp hạng quán. - **"Boom" (random elimination)** → cưỡng chế ra quyết định cuối cùng.
...
![Kiến trúc hệ thống LunchSync](/images/proposal/lunchsync.png)
